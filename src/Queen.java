...
public class Queen extends Pieces {
	Queen(team color, Columns col, int row){
		super("src/BlackQueen.png");
		if (color == team.black) {
			super.setImage("src/BlackQueen.png");
		} else {
			super.setImage("src/WhiteQueen.png");
		}
	...
	public ArrayList<Coordinate> possibleMoves() {
		...
		int[] directionXList = new int[] { 0, 1, 1, 1, 0, -1, -1, -1};
		int[] directionYList = new int[] { 1, 1, 0, -1, -1, -1, 0, 1};
